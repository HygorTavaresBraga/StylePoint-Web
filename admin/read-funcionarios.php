    ...
    <?php
      ...
      while($array = mysqli_fetch_array($busca)){
        ...
        echo '<tr class="text-center">';
          echo '<td>'.$codigo.'</td>';
          if(strlen($array['fotoFuncionario']) < 1){
            echo'<td><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
          ...
          echo '<td>'.$admissaoFuncionario.'</td>';
          echo '<td>'.$emailFuncionario.'</td>';
          echo '<td>'.$senhaFuncionario.'</td>';
        echo '</tr>';
      }

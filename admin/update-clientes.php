...
<table class="table table-striped">
  <thead class="thead-dark">
    ...
    while($array = mysqli_fetch_array($busca)){
      ...
      echo '<form action="action-update-cliente.php" method="POST">';
        echo '<tr class="text-center">';
        echo '<td>'.$codigo.'</td>';
        echo '<td><img style="border-radius:50%; text-align:center;" width="80" height="80" src="../area-cliente/assets/clientes/'.$fotoPerfil.'"></img></td>';
        echo '<td><input readonly style="background:none; border:0px; width:100%; color:#ebebeb; text-align:center" name="nomeCliente" type="text" value="'.$nomeCliente.'"></td>';
        echo '<td>'.$cpf.'</td>';
        echo '<td>'.$email.'</td>';
        echo '<td><button type="submit" id="btn-adm">Editar</button></td>';
        echo '</tr>';
      echo'</form>';
    }
